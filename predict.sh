...
# python predict.py --file data/reviews.txt --label data/labels.txt --seqlen 200 -n 3 --model data/rnnlm.model --input_vocab data/input_vocab.bin --label_vocab data/label_vocab.bin
